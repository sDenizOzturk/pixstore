  ...
  [941],
  {
    ...
    7052: (e, n, i) => {
      ...
      const a = {
        ...
        l = [
          {
            value: '<code>initPixstoreBackend</code>',
            id: 'initpixstorebackend',
            level: 2,
          },
          ...
          children: [
            (0, r.jsxs)(n.p, {
              children: [
                ...
                (0, r.jsx)(n.code, { children: 'pixstore/backend' }),
                ' entrypoint:',
              ],
            }),
            '\n',
            ...
            (0, r.jsx)(n.h2, {
              id: 'initpixstorebackend',
              children: (0, r.jsx)(n.code, { children: 'initPixstoreBackend' }),
            }),
            '\n',
            (0, r.jsx)(n.p, {
              children:
            ...
            (0, r.jsxs)(n.table, {
              children: [
                ...
                (0, r.jsx)(n.tbody, {
                  children: (0, r.jsxs)(n.tr, {
                    children: [
                      (0, r.jsx)(n.td, { children: 'config' }),
                      (0, r.jsxs)(n.td, {
                        children: [
                          (0, r.jsx)(n.code, { children: 'Partial<' }),
                          (0, r.jsx)(n.a, {
                            href: '../types#pixstorebackendconfig',
                            children: (0, r.jsx)(n.code, {
                      ...
                      (0, r.jsx)(n.td, {
                        children:
                          'Optional runtime configuration for the backend.',
                      }),
                    ],
                  }),
                }),
              ...
              children: [
                (0, r.jsxs)(n.p, {
                  children: [
                    ...
                    (0, r.jsx)(n.strong, { children: 'must' }),
                    ' implement your own image-serving endpoint using ',
            ...
            (0, r.jsxs)(n.p, {
              children: [
                '\ud83d\udcc4 Source: ',
                (0, r.jsx)(n.a, {
                  href: 'https://github.com/sDenizOzturk/pixstore/blob/main/src/backend/index.ts',
                  children: (0, r.jsx)(n.code, {
                    children: 'src/backend/index.ts',
                  }),
                }),
              ],
            }),
