    ...
    1377: (e, t, n) => {
      ...
      function h() {
        const { shown: e, scrollToTop: t } = (function ({ threshold: e }) {
          const [t, n] = (0, a.useState)(!1),
            o = (0, a.useRef)(!1),
            { startScroll: i, cancelScroll: s } = (0, d.gk)()
          return (
            (0, d.Mq)(({ scrollY: t }, a) => {
              const i = a?.scrollY
              i &&
            ...
            (0, u.$)((e) => {
              e.location.hash && ((o.current = !0), n(!1))
            }),
            { shown: t, scrollToTop: () => i(0) }
          )
        })({ threshold: 300 })
      ...
      function C({ onClick: e }) {
        return (0, b.jsx)('button', {
          ...
          onClick: e,
          children: (0, b.jsx)(_, { className: A }),
        })
      }
      var k = n(5041),
        S = n(9532)
      ...
      function I({ children: e }) {
        ...
        return (0, b.jsx)(N.Provider, { value: o, children: e })
      }
      var y = n(1422),
        B = n(9169),
        w = n(8774),
      ...
      function M({
        ...
        const { items: d, label: u, collapsible: m, className: h, href: p } = e,
          ...
          v = (0, r.w8)(e, n),
          _ = (0, B.ys)(p, n),
          { collapsed: g, setCollapsed: A } = (0, y.u)({
        ...
        return (
          ...
          })({ isActive: v, collapsed: g, updateCollapsed: I }),
          (0, a.useEffect)(() => {
            m && null != C && C !== c && x && A(!0)
          }, [m, C, c, A, x]),
          (0, b.jsxs)('li', {
      ...
      function R({
        ...
        const { href: l, label: d, className: u, autoAddBaseUrl: m } = e,
          h = (0, r.w8)(e, n),
          p = (0, H.A)(l)
        return (0, b.jsx)(
          'li',
          {
            ...
            children: (0, b.jsxs)(w.A, {
              className: (0, o.A)('menu__link', !p && P, {
                'menu__link--active': h,
              }),
              autoAddBaseUrl: m,
      ...
      function D({ item: e, level: t, index: n }) {
        const { value: a, defaultStyle: i, className: r } = e
        return (0, b.jsx)(
          'li',
          {
            className: (0, o.A)(
      ...
      function F({ item: e, ...t }) {
        switch (e.type) {
          case 'category':
            return (0, b.jsx)(M, { item: e, ...t })
          case 'html':
            return (0, b.jsx)(D, { item: e, ...t })
          default:
            return (0, b.jsx)(R, { item: e, ...t })
        }
      }
      function U({ items: e, ...t }) {
        const n = (0, r.Y)(e, t.activePath)
        return (0, b.jsx)(I, {
          children: n.map((e, n) =>
            (0, b.jsx)(F, { item: e, index: n, ...t }, n),
          ),
        })
      }
      const V = (0, a.memo)(U),
      ...
      function z({ path: e, sidebar: t, className: n }) {
        ...
        return (0, b.jsx)('nav', {
          ...
          className: (0, o.A)('menu thin-scrollbar', Y, i && K, n),
          children: (0, b.jsx)('ul', {
            className: (0, o.A)(s.G.docs.docSidebarMenu, 'menu__list'),
            children: (0, b.jsx)(V, { items: t, activePath: e, level: 1 }),
          }),
        })
      }
      ...
      function X({ path: e, sidebar: t, onCollapse: n, isHidden: a }) {
        ...
        return (0, b.jsxs)('div', {
          className: (0, o.A)(q, i && O, a && J),
          children: [
            i && (0, b.jsx)(v.A, { tabIndex: -1, className: Q }),
            (0, b.jsx)(z, { path: e, sidebar: t }),
            s && (0, b.jsx)(C, { onClick: n }),
          ],
        })
      }
      const Z = a.memo(X)
      ...
      function ne(e) {
        return (0, b.jsx)($.GX, { component: te, props: e })
      }
      const ae = a.memo(ne)
      function oe(e) {
        const t = (0, f.l)(),
      ...
      function se({ toggleSidebar: e }) {
        return (0, b.jsx)('div', {
          ...
          onKeyDown: e,
          onClick: e,
          children: (0, b.jsx)(_, { className: ie.expandButtonIcon }),
        })
      }
      const re = {
      ...
      function le({
        ...
        const { pathname: i } = (0, x.zy)(),
          [r, c] = (0, a.useState)(!1),
          l = (0, a.useCallback)(() => {
            r && c(!1), !r && (0, p.O)() && c(!0), n((e) => !e)
          }, [n, r])
        return (0, b.jsx)('aside', {
          className: (0, o.A)(
            s.G.docs.docSidebarContainer,
            re.docSidebarContainer,
            t && re.docSidebarContainerHidden,
          ),
          onTransitionEnd: (e) => {
            e.currentTarget.classList.contains(re.docSidebarContainer) &&
              t &&
              c(!0)
          },
          children: (0, b.jsx)(ce, {
      ...
      function ue({ hiddenSidebarContainer: e, children: t }) {
        ...
        return (0, b.jsx)('main', {
          className: (0, o.A)(
            de.docMainContainer,
            (e || !n) && de.docMainContainerEnhanced,
          ),
          children: (0, b.jsx)('div', {
            className: (0, o.A)(
              'container padding-top--md padding-bottom--lg',
              de.docItemWrapper,
              e && de.docItemWrapperEnhanced,
            ),
            children: t,
          }),
        })
          ...
          children: [
            ...
            (0, b.jsxs)('div', {
              ...
              children: [
                ...
                (0, b.jsx)(ue, { hiddenSidebarContainer: n, children: e }),
              ],
            }),
          ],
        })
      ...
      function pe(e) {
        const t = (0, r.B5)(e)
        if (!t) return (0, b.jsx)(he.A, {})
        const { docElement: n, sidebarName: a, sidebarItems: l } = t
        return (0, b.jsx)(i.e3, {
          className: (0, o.A)(s.G.page.docsDocPage),
          children: (0, b.jsx)(c.V, {
            name: a,
            items: l,
            children: (0, b.jsx)(be, { children: n }),
          }),
        })
      }
    },
